...
public class Rime {
    ...
    public void setDictionnaireTypeRime(){ 
        ...
        // *!* représent les valeurs que l'on va utilisé pour associé le type de rime au phoneme dans setRime
    }
    ...
    // test si la rime est correcte connu ou incorrect  selon le numéro du vers donné et le phoneme de celui-ci
    public String comparateurRime(Phoneme p, Integer i){
        String comp="";
        // si l'écriture du phoneme est la même que l'écriture du phoneme obtenue en get les valures des deux dictionnaire
